<template>
  <div v-if="event.id">
    ...
    <div class="row">
      <div class="col">
        <p v-if="projects.length > 0">You have already registered a coolest project. Do you want to edit it or do you have another team you want to register?</p>
        <p v-else>You have not registered a coolest project. Do you want to register one?</p>
      </div>
    </div>
